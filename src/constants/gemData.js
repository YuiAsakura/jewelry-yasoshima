...
export const GEM_DATA = {
  ruby: {
    ...
    steps: [
      ...
      { id: 'pointer', actionName: '温度制御', label: '高温でルビー結晶を育てる', timeLimit: 15, hint: '指定の温度にポインターを合わせよう！', description: '高温の炎で原料を溶かすと、酸化アルミニウム Al₂O₃ が冷えながら規則正しく並び、ルビーの結晶が成長します。', introImage: "", image: "/src/assets/images/group_ruby.png", targets: [250, 500, 750, 1000, 1250, 1500, 1750, 2000] },
  ...
  sapphire: {
    ...
    steps: [
      ...
      { id: 'pointer', actionName: '温度制御', label: '高温で結晶を育てる', timeLimit: 15, hint: '指定の温度にポインターを合わせよう！', description: '原料を高温で溶かすと、酸化アルミニウム Al₂O₃ が結晶として成長します。', introImage: "", image: "/src/assets/images/group_sapphire.png", targets: [250, 500, 750, 1000, 1250, 1500, 1750, 2000] },
